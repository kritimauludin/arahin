    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark d-inline">{{$book[0]->title_book}} - Chapter {{$chapter}}</h6>
            </div>
            <div class="card-body">
                <form action="/mybook/chapters" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title_chapter') is-invalid @enderror" id="title_chapter" name="title_chapter" value="{{old('title_chapter')}}" required autofocus>
