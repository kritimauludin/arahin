    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark d-inline">Create New Book</h6>
            </div>
            <div class="card-body">
                <form action="/mybook/books" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="title_book" class="form-label">Title</label>
                        <input type="text" class="form-control @error('title_book') is-invalid @enderror" id="title_book" name="title_book" value="{{old('title_book')}}" required autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <textarea class="form-control" name="excerpt_book" id="excerpt_book" rows="5"></textarea>
                    </div>
                    <div class="mb-3">
