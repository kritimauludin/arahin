...
@section('title', 'Contact Page - Arahin Media Kreasi')
@section('content')
<main>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="/contact/sendmessage" method="post" id="contactForm">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            ...
                            <p>Kota Bogor, 16111</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+62 857 1876 3119</h3>
