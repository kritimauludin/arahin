...
<head>
    ...
    <title>Arahin - {{$book[0]->title_book}}</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('storage')}}/img/web-arahin/preload/icon.svg">
    <link rel="stylesheet" type="text/css" href="{{asset('template')}}/book-animation/css/jquery.jscrollpane.custom.css" />
    <link rel="stylesheet" type="text/css" href="{{asset('template')}}/book-animation/css/bookblock.css" />
    <link rel="stylesheet" type="text/css" href="{{asset('template')}}/book-animation/css/custom.css" />
    <script src="{{asset('template')}}/book-animation/js/modernizr.custom.79639.js"></script>
</head>
...
<body>
    <div id="container" class="container">
        ...
        <div class="menu-panel">
            ...
            <ul id="menu-toc" class="menu-toc">
                <li class="menu-toc-current"><a href="#home">HOME</a></li>
                @for($i=1; $i<= $items; $i++) <li><a href="#item{{$i}}">Section {{$i}}</a></li>@endfor
            </ul>
        </div>
        ...
        <div class="bb-custom-wrapper">
            <div id="bb-bookblock" class="bb-bookblock">
                <div class="bb-item" id="home">
                    <div class="content">
                        <div class="scroller">
                            <h2>Cover This Chapter</h2>
                            <img src="{{asset('storage/'.$bookchapter->img_chapter)}}" width="100%" alt="">
                        </div>
                    </div>
                </div>

                @for($i=1; $i<= $items; $i++) <div class="bb-item" id="item{{$i}}">
                    <div class="content">
                        <div class="scroller">
                            <h2>{{$bookchapter->title_chapter }}</h2>
                            @for($section = 1; $section <= count($sections[$i]); $section++) {!!$sections[$i][$section]!!} @endfor <p><em>From <a href="/books/{{$book[0]->slug}}">"{{$book[0]->title_book}}"</a> by {{$book[0]->author->name}}</em></p>
                        </div>
                    </div>
            </div>
            @endfor
    ...
    <!-- /container -->
    <script src="{{asset('template')}}/book-animation/js/jquery.js"></script>
    <script src="{{asset('template')}}/book-animation/js/jquery.mousewheel.js"></script>
    <script src="{{asset('template')}}/book-animation/js/jquery.jscrollpane.min.js"></script>
    <script src="{{asset('template')}}/book-animation/js/jquerypp.custom.js"></script>
    <script src="{{asset('template')}}/book-animation/js/jquery.bookblock.js"></script>
    <script src="{{asset('template')}}/book-animation/js/page.js"></script>
    <script>
        $(function() {
